...
adress = 'rawdata/'
sell_data = pd.read_csv(adress + 'sale_future_data.csv', dtype='str')

sell_data = sell_data[[ '土地位置建物門牌', '交易標的', '建物型態', '移轉層次', '總樓層數', '編號']]
...
# 輸出尚未刪除資料的data
data.to_csv('Output_feature/sale_future_data_feature_cobra.csv')
...
# 輸出刪除資料後的data
data_delete.to_csv('Output_feature/sale_future_data_feature_deleted_cobra.csv')
