...
CODE_PATH = adress + 'code/MODEL/LGBM_Totalprice_all_add_variable_martin.py'
...
FIG_name = f'featureimportance_{timestamp}_Total_price_all_add_variable_notej.png'
lift_curve_name = f'liftcurve_{timestamp}_Total_price_all_add_variable_notej.png'
...
MODEL_NAME = f'model_{timestamp}_Total_price_all_add_variable_notej.pkl'
